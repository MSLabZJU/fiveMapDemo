...
public class PositionEstimate {
	...
	private float theta = 0;	//theta为两个坐标系之间的夹角。
	...
	public void estimatePosition(float stepLength, float orientation) {
		position[0] = (float) (position[0] + stepLength * Math.sin(orientation));
		position[1] = (float) (position[1] + stepLength * Math.cos(orientation));
		//坐标系转换，将地理坐标系转换为室内
